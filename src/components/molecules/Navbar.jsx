                        ...
                        <NavigationMenu.Item>
                            ...
                            <NavigationMenu.Content className="NavigationMenuContent">
                                <ul className="List two">
                                    <li>
                                        <NavigationMenu.Link>
                                            <a className={classNames('ListItemLink')} href="https://www.instagram.com/filosofiawpp/" target="_blank">
                                    ...
                                    <li>
                                        <NavigationMenu.Link>
                                            <a className={classNames('ListItemLink')} href="https://www.notion.so/DI-LOGOS-PLAT-NICOS-48e947e0c73b4d518145a4b83ab332e3" target="_blank">
                                    ...
                                    <li>
                                        <NavigationMenu.Link>
                                            <a className={classNames('ListItemLink')} href="https://www.evernote.com/shard/s513/client/snv?noteGuid=d73e3f67-0a8f-67ae-d2ba-fa74c4e9fd15&noteKey=8bf937abec1186e7380680fb59801cae&sn=https%3A%2F%2Fwww.evernote.com%2Fshard%2Fs513%2Fsh%2Fd73e3f67-0a8f-67ae-d2ba-fa74c4e9fd15%2F8bf937abec1186e7380680fb59801cae&title=META%2BDE%2BLEITURA" target="_blank">
                                                ...
                                                <p className="ListItemText">Lista de livros ordenada sobre filosofia com link de afiliado.</p>
                                            </a>
                                        </NavigationMenu.Link>
                                    </li>
                                    ...
                                    <li>
                                        <NavigationMenu.Link>
                                            <a className={classNames('ListItemLink')} href="https://anchor.fm/darlley" target="_blank">
                                    ...
                                    <li>
                                        <NavigationMenu.Link>
                                            <a className={classNames('ListItemLink')} href="https://github.com/Darlley/portfolio-nextjs" target="_blank">
