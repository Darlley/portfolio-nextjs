      ...
      <HeaderPage thumbnail="/lotr-1440x522.png">
        ...
        <div className="citation">
          <p>
            ...
            cheias de dúvidas, e as pessoas idiotas estão cheias de certezas". —
            Bertrand Russell
          </p>
        </div>
      </HeaderPage>
                    ...
                    <div className="flex items-start justify-between w-full">
                      <h3 className="w-full">
                        <Link
                          ...
                          className="flex py-2 text-lg font-bold text-slate-800 hover:text-primary-500"
                        >
                          {article.title}
                        </Link>
                      </h3>
                      {article.thumbnail && (
                        <div className="flex flex-col items-end justify-end gap-4 w-max">
                          ...
                          <span className="font-mono text-xs text-right text-slate-500 w-max">
