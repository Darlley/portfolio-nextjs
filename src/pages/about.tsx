        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <div className="grid items-start max-w-2xl grid-cols-1 mx-auto gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div>
              ...
              <dl className="grid grid-cols-2 gap-8 pt-6 mt-6 border-t border-gray-900/10 sm:grid-cols-4">
                ...
                <ul role="list" className="py-6 space-y-6">
                  ...
                  <li className="relative flex gap-x-4">
                    ...
                    <div className="relative flex items-center justify-center flex-none w-6 h-6 bg-white">
                      <svg className="w-6 h-6 text-secundary-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
